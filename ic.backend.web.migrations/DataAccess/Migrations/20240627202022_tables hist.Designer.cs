...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240627202022_tables hist")]
    partial class tableshist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.BendHistBusqCabecera", b =>
                {
                    b.Property<int>("IdBendHistBusqCabecera")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdBendHistBusqCabecera"));
                    ...
                    b.HasKey("IdBendHistBusqCabecera");

                    b.HasIndex("DeudorId");

                    b.HasIndex("TipoMedidaCautelarId");

                    b.ToTable("Bend_Hist_Busq_Cabeceras", (string)null);
                });

            modelBuilder.Entity("Domain.BendHistBusqCuentasBancariasDetalle", b =>
                {
                    b.Property<int>("IdBendHistBusqCuentasBancarias")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdBendHistBusqCuentasBancarias"));

                    b.Property<int>("BendHistBusqCabeceraId")
                        .HasColumnType("int");

                    b.Property<int?>("EstadoCuentasBancarias")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("MontoEmbargadoCuentasBancarias")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("ObservacionCuentasBancarias")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("UsuarioId")
                        .HasColumnType("int");

                    b.HasKey("IdBendHistBusqCuentasBancarias");

                    b.HasIndex("BendHistBusqCabeceraId");

                    b.ToTable("BEND_HIST_BUSQ_CUENTAS_BANCARIAS_DETALLES", (string)null);
                });

            modelBuilder.Entity("Domain.BendHistBusqEstablecimientoComerciosDetalle", b =>
                {
                    b.Property<int>("IdBendHistBusqEstablecimientoComercio")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdBendHistBusqEstablecimientoComercio"));
                    ...
                    b.Property<string>("NumeroRegistroEstablecimiento")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("ObservacionEstablecimiento")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("UsuarioId")
                        .HasColumnType("int");

                    b.HasKey("IdBendHistBusqEstablecimientoComercio");

                    b.HasIndex("BendHistBusqCabeceraId");

                    b.ToTable("BEND_HIST_BUSQ_ESTABLECIMIENTOS_COMERCIOS_DETALLES", (string)null);
                });

            modelBuilder.Entity("Domain.BendHistBusqOtrosDetalle", b =>
                {
                    b.Property<int>("IdBendHistBusqOtro")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdBendHistBusqOtro"));

                    b.Property<int>("BendHistBusqCabeceraId")
                        .HasColumnType("int");

                    b.Property<int?>("EstadoOtros")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ObservacionOtros")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("TieneOtros")
                        .HasColumnType("bit");

                    b.Property<int?>("UsuarioId")
                        .HasColumnType("int");

                    b.HasKey("IdBendHistBusqOtro");

                    b.HasIndex("BendHistBusqCabeceraId");

                    b.ToTable("BEND_HIST_BUSQ_OTROS_DETALLES", (string)null);
                });

            modelBuilder.Entity("Domain.BendHistBusqRemanentesDetalle", b =>
                {
                    b.Property<int>("IdBendHistBusqRemanente")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdBendHistBusqRemanente"));

                    b.Property<int>("BendHistBusqCabeceraId")
                        .HasColumnType("int");

                    b.Property<int?>("EstadoRemanente")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ObservacionRemanente")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("TieneRemanente")
                        .HasColumnType("bit");

                    b.Property<int?>("UsuarioId")
                        .HasColumnType("int");

                    b.HasKey("IdBendHistBusqRemanente");

                    b.HasIndex("BendHistBusqCabeceraId");

                    b.ToTable("BEND_HIST_BUSQ_CUENTAS_REMANENTES_DETALLES", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.BendHistBusqCuentasBancariasDetalle", b =>
                {
                    b.HasOne("Domain.BendHistBusqCabecera", "BendHistBusqCabecera")
                        .WithMany()
                        .HasForeignKey("BendHistBusqCabeceraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BendHistBusqCabecera");
                });
